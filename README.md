...
необходимо логирование в файл, используйте библиотеку `@dlabs71/d-logger-node`
...
наследующие класс `LogAppender` (далее аппендеры). Из коробки доступно 2 реализации:
